...
export default async function HaroldPage() {
  ...
  return (
    <section className="space-y-6">
      <ModuleHeader eyebrow="Intelligent Operations" title="Harold AI" description="Ask Harold through the secure n8n AI workflow, keep a complete conversation history, and hand over to a Team Access member when human support is needed." />
